---
title: "GoKit Gin Integration: Request Logging and Middleware"
sidebarTitle: "Gin Integration"
description: "Use GoKit's Gin middleware for automatic per-request logging with request ID, client IP, HTTP method, path, and level-aware completion entries."
---
